...
/*!**********************************************************************!*\
  !*** ../demo1/src/js/custom/apps/user-management/roles/view/view.js ***!
  \**********************************************************************/
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Вы действительно хотите удалить " + userName + "?",
                    icon: "warning",
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        text: "Вы удалили всех выбранных клиентов!.",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok!",
                        customClass: {
                    ...
                    Swal.fire({
                        text: "Выбранные клиенты не были удалены.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok",
                        customClass: {
