...
/*!***********************************************************************!*\
  !*** ../demo1/src/js/custom/apps/user-management/permissions/list.js ***!
  \***********************************************************************/
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Вы дейстивительно хотите удалить? " + permissionName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: "Вы удалили " + permissionName + "!.",
                            icon: "success",
                            buttonsStyling: false,
