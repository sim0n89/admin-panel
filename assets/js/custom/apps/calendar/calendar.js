...
var KTAppCalendar = function () {
    ...
    var initCalendarApp = function () {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: [
                ...
                {
                    id: uid(),
                    title: 'Выставка ИКТ 2021 - Выпуск продукта',
                    start: YM + '-03',
    ...
    const initPopovers = (element) => {
        ...
        const popoverHtml = '<div class="fw-bolder mb-2">' + data.eventName + '</div><div class="fs-7"><span class="fw-bold">Начало:</span> ' + startDate + '</div><div class="fs-7 mb-4"><span class="fw-bold">Окончание:</span> ' + endDate + '</div><div id="kt_calendar_event_view_button" type="button" class="btn btn-sm btn-light-primary">Подробнее</div>';
            ...
            form,
            {
                fields: {
                    ...
                    'calendar_event_start_date': {
                        validators: {
                            notEmpty: {
                                message: 'Дата начала - обязательное'
                            }
                        }
                    },
                    'calendar_event_end_date': {
                        validators: {
                            notEmpty: {
                                message: 'Дата окончания - обязательно'
                            }
                        }
                    }
                },
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Добавить новое событие";
    ...
    const handleEditEvent = () => {
        // Update modal title
        modalTitle.innerText = "Редактировать событие";
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            // Show popup confirmation 
                            Swal.fire({
                                text: "Новое событие добавлено в календарь!",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok!",
                                customClass: {
        ...
        viewDeleteButton.addEventListener('click', e => {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        text: "Ваше событие не было удалено",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok!",
                        customClass: {
