    ...
    var initChartsWidget3 = function() {
        ...
        var options = {
            ...
            stroke: {
                ...
                show: true,
                width: 3,
                colors: [baseColor, '#43CB92']
            },
            xaxis: {
                categories: ['Фев', 'Март', 'Апр', 'Май', 'Июнь', 'Июль', 'Авг'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
            ...
            follow.addEventListener('click', function(e){
                ...
                if (follow.classList.contains("btn-success")) {
                     setTimeout(function() {
                        ...
                        follow.querySelector(".indicator-label").innerHTML = 'Подписаться';
                     ...
                     setTimeout(function() {
                        ...
                        follow.querySelector(".indicator-label").innerHTML = 'Подписан';
                        follow.disabled = false;
                    }, 1000);   
                }        
            });
